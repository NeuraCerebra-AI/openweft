...
const renderWizardRun = async (reader) => {
  ...
  await writeScreen(
    [
      ...
      'Popular workflow toolkit for Claude and Codex, by Jesse Vincent.',
      'Claude supports it through the plugin marketplace.',
      'It installs in your local Claude setup, not this repo.',
      'OpenWeft works without it. Skip is the default.',
      'After installing, start a new OpenWeft/Claude session.',
      'GitHub: github.com/obra/superpowers · If you already have it, ignore this note.',
      '› Skip — continue setup',
      '  Open Superpowers install guide',
